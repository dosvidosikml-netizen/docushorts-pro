...
━━━ БЛОК 6: КИНЕМАТОГРАФИЧЕСКАЯ КОНКРЕТИКА (ОБЯЗАТЕЛЬНО) ━━━
23. ЗАПРЕЩЁННЫЕ СЛОВА — АБСОЛЮТНЫЙ БАН в полях voice И visual:
    ...
    героический, отважный, загадочный, легенда, феноменальный.
    ПРИЧИНА: зритель не видит "мужество". Зритель видит "грязное лицо, стиснутые зубы
    и топор, занесённый над золотым шлемом". Запрещённые слова = пустые пиксели.

24. ПРАВИЛО МЕХАНИКИ (CRITICAL): Описывай ФИЗИКУ ПРОЦЕССА, не эмоции и не результат.
    ПЛОХО: "Рыцарь героически сражался в грязи."
    ХОРОШО: "Рыцарь в латах весом 40кг проваливается в пахотную грязь по колено при каждом шаге — скорость передвижения упала до 1км/ч."
    ПРАВИЛО: для каждого события отвечай — что конкретно произошло физически? Вес. Материал. Скорость. Температура. Звук.

25. ПРАВИЛО КОНТРАСТА МАТЕРИАЛОВ: В каждой сцене сталкивай два противоположных полюса.
    Шаблоны: Сталь↔Грязь / Золото↔Кровь / Шёлк↔Ржавчина / Мрамор↔Пепел / Лёд↔Огонь.
    Пример: "Полированный золотой герб на нагруднике медленно уходит в чёрную жижу поля."
    Контраст материалов = мгновенный визуальный образ для ИИ-генератора.

26. СТРУКТУРА "КАК?" а не "ЧТО?": Сценарий объясняет МЕХАНИЗМ события, не просто факт.
    ПЛОХО: "Англичане победили французов при Азенкуре."
    ХОРОШО: "Французские латы весили 40кг. Дождь превратил поле в болото. Каждый шаг — потеря равновесия. Английские лучники в льняных рубашках просто бежали по спинам тонущих."
    Зритель узнаёт секрет → досматривает до конца.

27. NO MARKDOWN В VOICE: Никаких ** вокруг слов. Это ломает TTS-диктора и выглядит дёшево.
    ПЛОХО: "Это был **конец** эпохи."   ХОРОШО: "Это был КОНЕЦ эпохи."
