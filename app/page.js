...
3. Массив "frames" должен содержать ТОЧНОЕ количество кадров. Один кадр = один imgPrompt + один vidPrompt. Разкадровка каждые 2-3 секунды.
4. Выдавай только JSON.`;

// УНИВЕРСАЛЬНЫЙ ОБРАБОТЧИК API (Лимит снижен до безопасных 3900 токенов, чтобы Groq не выдавал ошибку)
