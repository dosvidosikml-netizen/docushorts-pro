...
LAW 2 — СЕНСОРНЫЕ ТРИГГЕРЫ (Show, Don't Tell):
...
ФОРМУЛА: [эмоция] → [биология + физика + материал + цифра]

LAW 3 — РИТМИКА 1-2-3:
Чередуй: КОРОТКОЕ (2-3 слова) → СРЕДНЕЕ (7-10 слов) → УДАР (факт или шок).
Никаких деепричастных оборотов. Максимум 2 запятых в предложении. Руби фразы.
ПЛОХО: "Несмотря на то что условия были крайне тяжёлыми..."
ХОРОШО: "Условия — ад. Температура минус сорок. Выжил один из девяти."

LAW 4 — ЛОГИКА И ПРАВДОПОДОБНОСТЬ:
Если в теме нереалистичные факты — адаптируй САМОСТОЯТЕЛЬНО без предупреждений.
Либо превращай в метафору, либо подавай как "жуткую легенду/аномалию".

LAW 5 — ФИЗИКА ПРОЦЕССА:
...
LAW 6 — PATTERN INTERRUPT:
Каждые 3-4 фразы — смена ритма или угла атаки. Читатель не должен предугадывать следующее.

LAW 7 — ЭМОЦИОНАЛЬНЫЕ КАЧЕЛИ:
Дуга: любопытство → нарастающий страх/восторг → шок → облегчение/удовлетворение.

LAW 8 — КАПСЛОК = ВИЗУАЛЬНЫЙ ЯКОРЬ:
1-2 слова в каждом блоке КАПСЛОКОМ = картинка на экране для монтажёра.

LAW 9 — ФИНАЛ-CTA:
Последняя фраза = провокационный факт ИЛИ незакрытая интрига ИЛИ вопрос делящий людей на 2 лагеря.
БАН: мораль, резюме, риторические вопросы типа "Так стоит ли...?"

LAW 10 — ОБЪЁМ И ФОРМАТ:
Объём: ${wordLimitRule}. КРИТИЧНО!
${finalTwist ? `Скрытый твист: ${finalTwist}` : ""}
NO MARKDOWN: никаких ** в тексте. Акценты — только КАПСЛОКОМ.

БАН-ЛИСТ: "погрузимся", "давайте", "невероятно", "поразительно", "мало кто знает", "интересный факт", "таким образом", "подведём итог", "мужество", "легендарный", "удивительный", "уникальный", "героический", "феноменальный", "огонь в глазах", любые риторические вопросы в финале.`;
...
ЗАДАЧА: ПЕРЕПИСАТЬ сценарий сохранив ВСЕ факты и сюжет. Применить формулу АДРЕНАЛИН:

LAW 1 — СМЕРТЬ В ПЕРВОЙ СТРОКЕ: Первая фраза начинается с предыстории? Замени — начни с середины действия или шокирующего финала. Удар без вступления.

LAW 2 — СЕНСОРНЫЕ ТРИГГЕРЫ: Все абстрактные эмоции → физические ощущения.
"Он боялся" → "Сердце колотилось 180 ударов. Руки тряслись. Воздух не шёл в лёгкие."
"Было тяжело" → конкретный вес/число/ощущение/звук.

LAW 3 — РИТМИКА 1-2-3: Разбей длинные предложения. Чередуй: короткое (2-3 слова) → среднее → шоковый факт.

LAW 4 — ЛОГИКА: Нереалистичные факты адаптируй САМОСТОЯТЕЛЬНО без предупреждений — как метафору или жуткую легенду.

LAW 5 — ФИЗИКА: Каждое событие = механизм. Добавь: вес / скорость / температура / звук / цифра.

LAW 6 — НЕВОЗМОЖНОЕ: Минимум 2 сцены — физически неснимаемые на телефон. POV внутри тела / вид с орбиты / молекулярный уровень.

LAW 7 — КОНТРАСТ: Добавь 1 сочетание несочетаемого (Золото↔Грязь / Шёлк↔Ржавчина / Мрамор↔Пепел).

LAW 8 — ФИНАЛ-CTA: Риторический вопрос или мораль → провокационный факт-крючок делящий аудиторию на 2 лагеря.

СОХРАНИ: все факты, хронологию, персонажей, смысл. ОБЪЁМ: ${wordLimitRule}.
